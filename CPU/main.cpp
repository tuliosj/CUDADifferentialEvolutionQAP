...
int writeDown(const float *vec, const struct instance *inst, std::string instName, std::string file, double elapsed, std::atomic<long int> *costCalls, int popSize, int generations, float f, float cr, std::time_t executingSince) {
...
int main(void) {
    ...
    std::string file = "./res/results/cpu-" + ss.str() + ".tsv";
